EatUp uses Yelp Fusion API, Google Maps API, and the Geocoder gem. The backend is built on Rails and delivers JSON data to the frontend through a server-hosted API. 
